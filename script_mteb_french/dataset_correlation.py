...
if __name__ == '__main__':
    ...
    spearman_corr_matrix = results_df.corr(method='spearman')
    plt.figure(figsize=(10, 8))
    sns.heatmap(spearman_corr_matrix, cmap='coolwarm', fmt=".2f", linewidths=.5)
    plt.title('Spearman Rank Correlation Heatmap')
    plt.savefig('correlation_analysis/spearman_corr_heatmap.png', bbox_inches='tight')
